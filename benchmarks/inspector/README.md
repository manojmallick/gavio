...
Latest local release-prep check (2026-07-12): Python metadata 1.39% / full
3.39%, JavaScript metadata 0.31% / full 0.64%, Java metadata 1.43% / full
1.06%. All are below the CI thresholds above.
