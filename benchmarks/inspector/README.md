...
Latest local release-prep check (2026-07-12): Python metadata 7.06% / full
12.25%, JavaScript metadata 0.03% / full 0.01%, Java metadata 0.92% / full
0.13%. All are below the CI thresholds above.
