...
Latest local release-prep check (2026-07-12): Python metadata 2.45% / full
6.32%, JavaScript metadata 1.49% / full 1.58%, Java metadata 2.18% / full
1.58%. All are below the CI thresholds above.
