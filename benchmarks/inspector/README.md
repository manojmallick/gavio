...
Latest local release-prep check (2026-07-12): Python metadata 4.76% / full
8.98%, JavaScript metadata 1.41% / full 0.43%, Java metadata 0.65% / full
0.37%. All are below the CI thresholds above.
