...
Latest local release-prep check (2026-07-12): Python metadata 7.78% / full
16.21%, JavaScript metadata 3.91% / full 5.53%, Java metadata 3.79% / full
-3.24%. All are below the CI thresholds above.
