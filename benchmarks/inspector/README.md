...
Latest local release-prep check (2026-07-12): Python metadata 2.05% / full
5.03%, JavaScript metadata 1.50% / full 4.48%, Java metadata 1.96% / full
1.08%. All are below the CI thresholds above.
