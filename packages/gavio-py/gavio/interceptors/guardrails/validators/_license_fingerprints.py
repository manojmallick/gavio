...
8-word shingle of that license's canonical marker text. Only hashes are shipped
-- never the license text itself. Shingles shared by more than one license are
dropped so a hit is discriminative (e.g. GPL-2.0 vs GPL-3.0).
