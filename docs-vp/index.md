...
features:
  ...
  - icon: 🔁
    ...
    details: Retry with backoff, provider fallback, and timeouts wrap every call. Audit records every request as metadata + SHA-256 hashes — never raw text.
    link: /guide/architecture
...
# Maven: io.github.manojmallick:gavio-core:0.1.0   (Java 17+)
```
