---
description: "The Gavio 1.0 stable release gate, API compatibility guarantee, LTS policy, and release-readiness checks."
---
...
request/response models, JSON schemas in `spec/`, shared test vectors, documented
configuration, and Inspector endpoints.
...
```bash
python3 scripts/stable_release_gate.py --version 1.2.0
```
...
See [`STABILITY.md`](https://github.com/manojmallick/gavio/blob/main/STABILITY.md)
for the full policy.
