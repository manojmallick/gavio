...
| [`IntegrationAdapterPayload.schema.json`](./IntegrationAdapterPayload.schema.json) | Dependency-light ecosystem adapter payload envelope for gateway, eval, observability, and framework tools |
